...
<h1 style="margin-top: 20px; text-align: center; color: #000;">Pricing Table Styles</h1>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="pricingTable">
                    ...
                    <div class="price-value">
                        <span class="amount">10<span class="currency">$</span></span>
                    ...
                    <ul class="pricing-content">
                        ...
                        <li class="disable"><i class="fa fa-check"></i> 15 Subdomains</li>
                        <li class="disable"><i class="fa fa-check"></i> 20 Domains</li>
                    </ul>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="pricingTable green">
                    ...
                    <div class="price-value">
                        <span class="amount">20<span class="currency">$</span></span>
                        <span class="month">per month</span>
                    </div>
                    <ul class="pricing-content">
                        <li><i class="fa fa-check"></i> 50GB Disk Space</li>
