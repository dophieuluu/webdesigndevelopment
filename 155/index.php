...
<h1 style="margin-top: 20px; text-align: center; color: #000;">Progress Bar Styles</h1>
        ...
        <div class="col-md-6">
            <div class="progress_bar">
                ...
                <div class="pro-bg" style="background:#ed687c; width:45%;">
                    <div class="pro-value">45%</div>
                </div>
            ...
            <div class="progress_bar">
                <div class="pro-bar"></div>
                <div class="pro-bg" style="background:#049dff; width:75%;">
                    <div class="pro-value">75%</div>
                </div>
